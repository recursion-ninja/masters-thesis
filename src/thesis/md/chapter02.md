...
This work parameterizes the model in terms of $T$ and $N$ from the definition of *Non-adaptive* $(T, C, N, \textbf{\texttt{P}}, \epsilon)$ *CGKA Security*and limits the scope of verification to within the selected parameters.
...
Fortunately, Linear Temporal Logic (LTL) [@4567924] is an almost perfectly tailored language for representing the security guarantees at the CGKA abstraction level.
...
Consideration was made to use TopSpin [@DonaldsonM_AMAST2006], a PROMELA pre-processing plugin for SPIN which performs symmetry reduction as well.
