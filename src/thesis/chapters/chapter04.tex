...
\begin{table}[h!]
  \centering
  \caption{\label{tab:constants-from-parameters}Derivation constants in \CGKAmod{P}{T}{N} model from parameters\(T\) and \(N\).}
...
Global state variables differ from the constants bentioned above, as they are mutable and their values change throughout the course of program execution.
