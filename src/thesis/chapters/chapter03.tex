...
The model of \CGKAsec for the TreeKEM protocol described subsequently in this chapter, is be parameterized by $t \in \{ 0, T_{max} \}$.
...
We arrive at a formalized and reduced \CGKA{P}{T}{N} model for a$( \textbf{T}, \textbf{C}, \textbf{N} )$-attacker depicted in Figure \ref{fig:CGKA-old-flowchart}.
