...
To determine if the state is in the set, Spin treated the state vector as a bit-sting and feeds it to the \Abrev{BDD}, with \Abrev{BDD} accepting the string treating the state is in the set, the \Abrev{BDD} rejecting the string representing state is not being in the set.
