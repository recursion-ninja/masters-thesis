...
Symbolic model checking via process algebras, such as the communication between sequential process (CSP) algebra \autocite{Hoare1978}, has been use to great effect \autocite{roscoe1994model, Ryan1999, ryan2001modelling} and influenced the development of subsequent model checking approaches.
