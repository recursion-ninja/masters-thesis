...
Both ``on-the-fly'' verification and ``partial order'' reduction are enabled by default as they can be used in conjunction with minimal drawbacks \autocite{godefroid1990using, valmari1993fly, peled1994combining, holzmann1995improvement, couvreur1999fly}.
