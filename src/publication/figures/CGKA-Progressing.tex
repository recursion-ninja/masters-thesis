...
\node[label, right=1mm of BOXED.west, anchor=north] (LABEL) {\Large \scshape Serial, Bounded Gameplay};
...
%Northern Line
\path[line  ](FLO-COR.east) -| ([xshift=4mm]FLO-COR.east) |- (FLO-NXT.east);
\path[line  ](FLO-HRD.east) -| ([xshift=4mm]FLO-COR.east) |- (FLO-NXT.east);
\path[line  ](FLO-REV.east) -| ([xshift=4mm]FLO-COR.east) |- (FLO-NXT.east);
% Southern Line
\path[line  ](ALG-ADD.east) -| ([xshift=30mm] ALG-ADD.east) |- ([xshift=30mm] FLO-INC.center) |- (FLO-INC.east);
\path[line  ](ALG-RMV.east) -| ([xshift=30mm] ALG-ADD.east) |- ([xshift=30mm] FLO-INC.center) |- (FLO-INC.east);
\path[line  ](ALG-UPD.east) -| ([xshift=30mm] ALG-ADD.east) |- ([xshift=30mm] FLO-INC.center) |- (FLO-INC.east);
